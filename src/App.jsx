...
function App() {
  ...
  return (
      ...
      style={{backgroundColor: color}}>
        <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2 py-3 h-24">
          <div className="flex flex-wrap justify-center shadow-xl bg-white rounded-xl px-2 py-3 gap-5">
            ...
            <button onClick={()=>setColor("violet")} className="outline-none px-4 rounded-full text-white shadow-lg"
